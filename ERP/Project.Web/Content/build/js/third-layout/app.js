...
$(document).ready(function () {
    ...
    $(".hamburger-menu").on("click", function () {
        ...
        $("body").hasClass("sidebar-toggled") ? $(".main-sidebar").mCustomScrollbar({ theme: "minimal-dark" }) : $(".main-sidebar").mCustomScrollbar("destroy")
    }),
    ...
    $(".widget-reload").on("click", function () {
        ...
        o(e),
        window.setTimeout(function () { t(e) }, 3e3)
    }),
    $(".widget-remove").on("click", function () {
        $(this).closest(".widget").hide()
    }),
    $(".progress").length > 0 && $(".progress .progress-bar").progressbar(),
    $(".custombox").length > 0 && $(".custombox").on("click", function (o) {
        Custombox.open({ target: $(this).attr("href"), effect: $(this).attr("data-effect") || "fadein", overlayColor: $(this).attr("data-overlay-color") || "#000", overlayOpacity: $(this).attr("data-overlay-opacity") || .8 }),
        o.preventDefault()
    }),
