...
$(document).ready(function () {
    ...
    $(".sidebar-color").on("click", function () {
        ...
        $("body").removeClass(s).addClass(a).attr("data-sidebar-color", a),
        $("body").hasClass("sidebar-dark") ? $(".main-sidebar").css("background-image", "url('../build/images/backgrounds/10.jpg')") : $("body").hasClass("sidebar-light") && $(".main-sidebar").css("background-image","url('../build/images/backgrounds/11.jpg')")
    }),
    $(".sidebar-bg").on("click", function () {
        $("body").removeClass("sidebar-no-bg"),
        $("#sidebar-bg").prop("checked", !0);
        var a = "../build/images/backgrounds/" + $(this).attr("data-bg"); $(".main-sidebar").css("background-image", "url(" + a + ")")
    }),
    $("#sidebar-bg").on("click", function () {
