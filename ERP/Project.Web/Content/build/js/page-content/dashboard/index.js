$(document).ready(function () {
    ...
    $("#world-map").vectorMap({
        ...
        markers: a,
        markerStyle: { initial: { fill: "#E5343D", stroke: "#E5343D", "fill-opacity": 1, "stroke-width": 10, "stroke-opacity": .2, r: 5 }, hover: { stroke: "#1F364F", "stroke-width": 2, cursor: "pointer" } },
    ...
    var n = [[0, 57], [1, 58], [2, 93], [3, 11], [4, 40], [5, 93], [6, 29], [7, 19], [8, 87], [9, 14], [10, 130], [11, 91], [12, 80], [13, 49], [14, 59]],
        o = [{ label: "Orders", data: n, color: "#17A88B" }],
        r = { series: { lines: { show: !0, lineWidth: 1 }, points: { show: !0, lineWidth: 0, fill: !0, fillColor: "#17A88B" }, shadowSize: 0 }, grid: { hoverable: !0, borderWidth: 0 }, xaxis: { ticks: 0 }, yaxis: { ticks: 0 }, tooltip: { show: !0, content: "%s: %y", defaultTheme: !1 }, legend: { show: !1 } };
    $.plot($("#flot-order"), o, r);
    var i = [[0, 755], [1, 1133], [2, 1234], [3, 1448], [4, 1198], [5, 918], [6, 583], [7, 842], [8, 540], [9, 665], [10, 1195], [11, 742], [12, 1040], [13, 682], [14, 1190]],
        l = [{ label: "Revenue", data: i, color: "#0667D6" }],
        s = { series: { lines: { show: !0, lineWidth: 1 }, points: { show: !0, lineWidth: 0, fill: !0, fillColor: "#0667D6" }, shadowSize: 0 }, grid: { hoverable: !0, borderWidth: 0 }, xaxis: { ticks: 0 }, yaxis: { ticks: 0 }, tooltip: { show: !0, content: "%s: $%y", defaultTheme: !1 }, legend: { show: !1 } };
    ...
    var d = [[0, 150708], [1, 502507], [2, 220627], [3, 821182], [4, 233599], [5, 4087866], [6, 364625], [7, 3064625], [8, 236585], [9, 1040222], [10, 516876], [11, 292003]],
        ...
        g = {
            ...
            yaxis: {
                ...
                tickFormatter: function (e, t) { return e > 0 ? (e / 1e6).toFixed(t.tickDecimals) + " M" : (e / 1e6).toFixed(t.tickDecimals) }
            },
            tooltip: { show: !1 },
    ...
    }, function (e, t, a) { $("#daterangepicker span").html(e.format("MMMM D, YYYY") + " - " + t.format("MMMM D, YYYY")) }),

    $("#daterangepicker span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")),
    Morris.Donut({ element: "morris-browser", data: [{ label: "Chrome", value: 40 }, { label: "Firefox", value: 35 }, { label: "IE", value: 25 }], resize: !0, colors: ["#1F364F", "#0667D6", "#E6E6E6"], formatter: function (e) { return e + "%" } }),
    ...
    u.buttons().container().appendTo("#order-table_wrapper .col-sm-6:eq(0)"),
    $(".draggable li").each(function () { $(this).data("event", { title: $.trim($(this).text()), stick: !0 }), $(this).draggable({ zIndex: 999, revert: !0, revertDuration: 0 }) }),
    ...
    var p = [[0, 75], [1, 69], [2, 64], [3, 65], [4, 78], [5, 77], [6, 75], [7, 68], [8, 64], [9, 62], [10, 67], [11, 75], [12, 73], [13, 68], [14, 75], [15, 72], [16, 73], [17, 62], [18, 76], [19, 74], [20, 64], [21, 77], [22, 80], [23, 71]],
        ...
        v = { series: { lines: { show: !0, lineWidth: 2 }, points: { show: !0, lineWidth: 4 }, shadowSize: 0 }, grid: { hoverable: !0, borderWidth: 0 }, xaxis: { ticks: 0 }, yaxis: { ticks: 0 }, tooltip: { show: !0, content: "%y %s", defaultTheme: !1 }, legend: { show: !1 } }; $.plot($("#flot-weather"), f, v)
});